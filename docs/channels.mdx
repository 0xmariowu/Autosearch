---
title: Channels
description: All 34 search channels — dedicated connectors for code, academic, community, Chinese, video, and business platforms.
---

AutoSearch has 34 dedicated search channels. Each channel has its own connector — not just web search with `site:` filters.
...
| `huggingface` | Model and dataset discovery by downloads |
...
| ScrapeCreators | `SCRAPECREATORS_API_KEY` | Full Reddit comments + Twitter engagement data |
