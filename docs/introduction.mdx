---
title: Introduction
description: Research that gets smarter every time you use it. 34 search channels, self-evolving queries, cited reports.
---
...
34 search channels. Self-evolving queries. Cited reports. Zero API keys required.
...
| **Academic sources** | 34 dedicated connectors | 1 | 0 |
