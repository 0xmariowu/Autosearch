...
def run(query: str, query_category: str) -> dict[str, object]:
    ...
    return _result_payload(
        ...
        sample=None,
        error=(
            "NearHuiwen/TiktokDouyinCrawler provides a-bogus signing function only; "
            "rule-3 bans self-written HTTP even with imported signing. Use "
            "douyin__shilonglee_crawler or seo__douyin instead."
        ),
    )
